...
const Login = () => {
  ...
  const handleGoogleSuccess = (credentialResponse) => {
    ...
    console.log(profile);
    navigate('/home', { state: { name: profile.name, email: profile.email, loginMethod: 'login' } });
  };
      ...
      <div className="login-box">
        ...
        <div className="social-media-signup">
          <GoogleLogin
            ...
            style={{ maxWidth: '240px', marginBottom: '10px', cursor: 'pointer' }} // Inline styling added here
          />
          <LoginSocialFacebook
          ...
          >
            <FacebookLoginButton className="signup-button" style={{ maxWidth: '240px', marginBottom: '10px', cursor: 'pointer' }} /> 
          </LoginSocialFacebook>
          <LinkedIn
